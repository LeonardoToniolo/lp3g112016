        ...
        switch (action) {
            case "register":
                ...
                if (temp1 != null) {
                    ...
                    request.getSession().setAttribute("error", "username alread registred");
                    break;
                } else if (temp2 != null){
                    responsePage = "error.jsp";
                    request.getSession().setAttribute("error", "email alread registred");
                    break;
                }
            ...
            case "login":
                ...
                if(temp3 == null){
                    ...
                    responsePage = "error.jsp";
                    request.getSession().setAttribute("error", "password does not match");
                }else{
